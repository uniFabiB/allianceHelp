...
- **Graham, Cedar, Niagara are too outdated for vscode** -> downgrade to a previous version (version 1.98 (Feb 2025) seems to work) of vscode
  ...
  - Hold updates `vscode/settings/update.mode = manual` and `sudo apt-mark hold code`
